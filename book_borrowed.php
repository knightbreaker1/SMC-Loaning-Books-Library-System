    ...
    <div class="mainwrapper">
        <div class="leftpanel">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li><a href="student_index.php"><i class="fa fa-home"></i> <span>Home</span></a></li>
                <li class="active"><a href="book_borrowed.php"><i class="fa fa-users"></i> <span>Book Borrowed</span></a></li>
            </ul>
        </li>
    </ul>
    ...
    <div class="contentpanel">
        ...
        <div class="panel panel-primary-head">
            <div class="panel-heading">
                <h4 class="panel-title">List Of Book Borrowed</h4>
                <p>This section is the list of book that you have borrowed from the library.</p>
            </div><!-- panel-heading -->
        ...
        <thead>
            <tr>
                ...
                <?php
                $count = 0;
                $book = mysqli_query($conn, "SELECT * FROM book as b,borrow_book as bb where b.book_id=bb.book_id and bb.student_id='$student_id' order by borrow_book_id desc");
