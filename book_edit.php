            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    ...
                    if(isset($_GET['edit'])){
                        ...
                        $sqll = "SELECT * from book where book_id='".$edit."'";
                     ...
                     ?>
                        <form name="form" action="#" method="POST" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            ...
                            <input type="hidden" name="book_id" id="book_id" required value="<?php echo $row['book_id']; ?>">

                            <div class="form-group">
                                <label class="col-sm-4 control-label">Book Title</label>
                                <div class="col-sm-8">
                                    <input type="text" name="title" id="title" placeholder="Book Title" class="form-control" value="<?php echo $row['title']; ?>">
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="author" id="author" placeholder="Book Author" class="form-control" value="<?php echo $row['author']; ?>">
                                    <span class="help-block">Input the Author of this book.</span>
                                </div>
                            </div>    

                            <div class="form-group">
                                <label id="publish" name="publish" class="col-sm-4 control-label">Publish</label>
                                <div class="col-sm-8">
                                    <textarea id="publish" name="publish" rows="5"><?php echo $row['publish']; ?></textarea>
                                </div>
                            </div>
                        ...
                        <div class="panel-footer">
                            <button type="subgmit" name="update" value="Update" class="btn btn-primary mr5">Update</button>
    ...
    if(isset($_POST['update'])){
        ...
        {
            $update = $conn->query("update book SET title = '$title', author = '$author', publish = '$publish' WHERE book_id= '$book_id'");
        ...
        else
        {
            ...
            $update = $conn->query("update book SET title = '$title', author = '$author', publish = '$publish', image = '$image' WHERE book_id= '$book_id'");
