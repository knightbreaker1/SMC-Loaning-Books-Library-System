    ...
    <div class="contentpanel">
        ...
        <div class="panel panel-primary-head">
            <div class="panel-heading">
                ...
                <p>You can add and remove books in this tables.</p>
            </div><!-- panel-heading -->

            <br><center>
            <a href="add_book.php"> <button class="btn btn-warning btn-rounded">Add Book</button> </a>
            </center>
            <br>
            <br>
    <table border="1" >
            ...
            <tr>
                ...
                if(mysqli_num_rows ($book) > 0){
                    while($row = mysqli_fetch_array($book)){
                        ...
                        echo "<td>";
                        echo "<a href='book_edit.php?edit=".$row['book_id']."' >Edit</a>";
                        echo '</td>';
                        echo "<td>";
                        echo "<a href='manage_book.php?delete=".$row['book_id']."' onclick='return confirm(\"Are you sure you want to do this?\")' type='button'>Delete</a>";
                        echo '</td>';        
                        echo '</tr>'; 
                    }
                }
...
<?php
            if(isset($_GET['delete'])){
                ...
                if($conn->query($sql) == TRUE){
                    ...
                    echo "<script>location.replace('manage_book.php')</script>";
                }
                else{
