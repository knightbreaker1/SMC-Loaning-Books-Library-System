    ...
    <div class="mainwrapper">
        <div class="leftpanel">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="staff_index.php"><i class="fa fa-home"></i> <span>Home</span></a></li>
    ...
    <div class="contentpanel">
        ...
        <div class="panel panel-primary-head">
            <div class="panel-heading">
                ...
                <p>This is the system reports.</p>
            </div><!-- panel-heading -->
        ...
        <thead>
            <tr>
                ...
                <?php
                $count = 0;
                $book = mysqli_query($conn, "SELECT * FROM book as b,borrow_book as bb, student as s where b.book_id=bb.book_id and s.student_id=bb.student_id and bb.status='Return Succesfully' order by borrow_book_id desc");
                ...
                if(mysqli_num_rows ($book) > 0){
                    while($row = mysqli_fetch_array($book)){
                        ...
                        echo '<td>';
                        echo ''.$row['return_book_date'].' '.$row['return_book_time'];
                        echo '</td>';
